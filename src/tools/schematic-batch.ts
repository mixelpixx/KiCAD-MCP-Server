...
export function registerSchematicBatchTools(server: McpServer, callKicadScript: CommandFunction) {
    ...
    "update_symbol_from_library",
    {
      ...
      inputSchema: z.object({
        ...
        backupDir: z
          ...
          .optional()
          .describe(
            "Backup folder with matching .kicad_sch filenames (for repairMirrorFromBackup)",
          ),
      }),
    },
    async (args: any) => {
  ...
  registerKiCadTool(
    ...
    "replace_schematic_component",
    {
      ...
      inputSchema: z.object({
        ...
        newSymbol: z
          .string()
          .describe("New symbol in 'Library:Symbol' form (e.g., Device:D_Zener)"),
        newRotation: z
          .number()
          .optional()
