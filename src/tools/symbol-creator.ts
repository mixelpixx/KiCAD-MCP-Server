...
export function registerSymbolCreatorTools(server: McpServer, callKicadScript: CommandFunction) {
  ...
  registerKiCadTool(
    ...
    "delete_symbol",
    {
      description: "Remove a symbol from a .kicad_sym library file.",
      inputSchema: z.object({
  ...
  registerKiCadTool(
    ...
    "list_symbols_in_library",
    {
      description: "List all symbol names in a .kicad_sym library file.",
      inputSchema: z.object({
        libraryPath: z.string().describe("Path to the .kicad_sym file"),
      }),
    },
  ...
  registerKiCadTool(
    ...
    "import_symbol",
    {
      ...
      inputSchema: z.object({
        ...
        targetLibraryPath: z
          .string()
          .describe("Path to the target .kicad_sym (created if missing)"),
