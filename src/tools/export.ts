    ...
    "export_3d",
    {
      ...
      inputSchema: z.object({
        ...
        includeComponents: z
          .boolean()
          .optional()
          .describe("Whether to include 3D component models"),
  ...
  registerKiCadTool(
    ...
    "export_netlist",
    {
      ...
      inputSchema: z.object({
        ...
        outputPath: z
          .string()
          .describe("Absolute path for the output file (e.g. /tmp/design.spice)"),
        format: z
  ...
  registerKiCadTool(
    ...
    "export_position_file",
    {
      ...
      inputSchema: z.object({
        ...
        format: z.enum(["csv", "ascii"]).optional().describe("File format (default: ascii)"),
        units: z.enum(["mm", "in"]).optional().describe("Units to use (default: in)"),
        side: z
    ...
    async ({ outputPath, boardPath, format, units, side }) => {
      logger.debug(`Exporting position file to: ${outputPath}`);
      const result = await callKicadScript("export_pos", {
        outputPath,
        boardPath,
        format,
        units,
    ...
    "export_vrml",
    {
      ...
      inputSchema: z.object({
        ...
        boardPath: z
          ...
          .optional()
          .describe("Path to the .kicad_pcb (default: current board)"),
        units: z.enum(["mm", "m", "in", "tenths"]).optional().describe("Output units"),
        modelsDir: z.string().optional().describe("Directory in which to store component models"),
        modelsRelative: z.boolean().optional().describe("Use relative paths to modelsDir"),
        force: z.boolean().optional().describe("Overwrite the output file"),
      }),
    },
    async ({ outputPath, boardPath, units, modelsDir, modelsRelative, force }) => {
      logger.debug(`Exporting VRML to: ${outputPath}`);
      const result = await callKicadScript("export_3d_cli", {
        outputPath,
        boardPath,
        format: "vrml",
        units,
    ...
    "export_gerbers",
    {
      ...
      inputSchema: z.object({
        ...
        precision: z
          .number()
          .optional()
          .describe("Gerber coordinate precision: 5 or 6 (default 6)"),
      }),
    },
    async (args) => {
    ...
    "export_drill",
    {
      ...
      inputSchema: z.object({
        ...
        excellonUnits: z
          .enum(["in", "mm"])
          .optional()
          .describe("Excellon output units (default mm)"),
    ...
    "export_ipc2581",
    {
      ...
      inputSchema: z.object({
        ...
        bomColDist: z
          .string()
          .optional()
          .describe("Value to insert into the BOM Distributor column"),
      }),
    },
    async (args) => {
    ...
    "export_gencad",
    {
      ...
      inputSchema: z.object({
        ...
        storeOriginCoord: z
          .boolean()
          .optional()
          .describe("Save the origin coordinates in the file"),
      }),
    },
    async (args) => {
    ...
    "export_pcb_pdf",
    {
      ...
      inputSchema: z.object({
        ...
        modeMultipage: z
          .boolean()
          .optional()
          .describe("Plot the layers to a single multi-page PDF"),
      }),
    },
    async (args) => {
    ...
    "export_pcb_svg",
    {
      ...
      inputSchema: z.object({
        ...
        pageSizeMode: z
          ...
          .optional()
          .describe(
            "Page sizing mode (0 frame+title block, 1 current page size, 2 board area only)",
          ),
  ...
  registerKiCadTool(
    ...
    "export_3d_cli",
    {
      ...
      inputSchema: z.object({
        ...
        includeInnerCopper: z
          .boolean()
          .optional()
          .describe("Export elements on inner copper layers"),
        includeSilkscreen: z
          .boolean()
          .optional()
        ...
        includeSoldermask: z
          .boolean()
          .optional()
          .describe("Export soldermask layers as flat faces"),
