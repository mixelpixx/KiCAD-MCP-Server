...
export class KiCADMcpServer {
  ...
  private async callKicadScript(command: string, params: any): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      const longRunningCommands = ['run_drc', 'export_gerber', 'export_pdf', 'export_3d', 'export_vrml', 'export_netlist', 'export_position_file', 'save_project', 'refill_zones', 'delete_all_traces'];
