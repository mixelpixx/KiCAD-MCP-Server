...
class EagleCommands:
    ...
    def __init__(self) -> None:
        from kicad_mcp.utils.kicad_cli import resolve_kicad_cli
    ...
    def _import_pcb(self, brd_file: str, pcb_out: str) -> Tuple[bool, str]:
        from kicad_mcp.utils.kicad_cli import kicad_cli_not_found_message
    ...
    def _create_project_file(pro_path: str, name: str, sch_uuid: Optional[str] = None) -> None:
        from kicad_mcp.utils.kicad_project import write_kicad_pro
