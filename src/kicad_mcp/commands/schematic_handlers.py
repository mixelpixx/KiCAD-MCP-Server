...
from kicad_mcp.utils.interactive_schematic import reload_kicad_schematic
from kicad_mcp.utils.sexpr_format import dumps as kicad_dumps
...
class SchematicHandlersMixin:
    ...
    def _handle_check_wire_collisions(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            from kicad_mcp.commands.schematic_analysis import check_wire_collisions
    ...
    def _handle_move_schematic_component(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            from kicad_mcp.commands.wire_dragger import WireDragger
    ...
    def _handle_find_wires_crossing_symbols(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            from kicad_mcp.commands.schematic_analysis import find_wires_crossing_symbols
    ...
    def _handle_find_orphaned_wires(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            from kicad_mcp.commands.schematic_analysis import find_orphaned_wires
    ...
    def _handle_list_floating_labels(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            from kicad_mcp.commands.wire_connectivity import list_floating_labels
    ...
    def _handle_snap_to_grid(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            from kicad_mcp.commands.schematic_snap import snap_to_grid
