...
# Make `import pcbnew` succeed everywhere (real module or raising proxy)
# BEFORE anything pulls in kicad_mcp.commands, whose modules import pcbnew at
# module level. See kicad_mcp.pcbnew_compat for the rationale.
from kicad_mcp.pcbnew_compat import ensure_pcbnew

PCBNEW_IMPORT_ERROR: Optional[str] = ensure_pcbnew()

import sexpdata
from kicad_mcp.annotations import AnnotationLoader
from kicad_mcp.commands.schematic_handlers import SchematicHandlersMixin
from kicad_mcp.commands.wire_manager import WireManager
from kicad_mcp.resources.resource_definitions import RESOURCE_DEFINITIONS, handle_resource_read
...
from kicad_mcp.utils.platform_helper import PlatformHelper
...
# pcbnew availability was resolved by ensure_pcbnew() at the top of this
# module (real module or raising proxy — never a fatal import error; the
# legacy stdio entry point re-imposes the historical fatal exit for the
# TypeScript host). Here we only bind the module and log the outcome.
IPC_REQUIRED_BUT_UNAVAILABLE = KICAD_BACKEND == "ipc" and not USE_IPC_BACKEND

import pcbnew  # type: ignore  # real module or raising proxy

if PCBNEW_IMPORT_ERROR is None:
...
try:
    ...
    from kicad_mcp.commands.eagle import EagleCommands
    from kicad_mcp.commands.freerouting import FreeroutingCommands
    from kicad_mcp.commands.jlcpcb import JLCPCBClient, test_jlcpcb_connection
    from kicad_mcp.commands.jlcpcb_parts import JLCPCBPartsManager
    from kicad_mcp.commands.library import (
        LibraryCommands,
    )
    from kicad_mcp.commands.library import LibraryManager as FootprintLibraryManager
    from kicad_mcp.commands.library_schematic import LibraryManager as SchematicLibraryManager
    ...
    from kicad_mcp.commands.schematic_batch import SchematicBatchCommands
    from kicad_mcp.commands.schematic_declutter import SchematicDeclutterCommands
    from kicad_mcp.commands.schematic_field_layout import SchematicFieldLayoutCommands
    ...
    from kicad_mcp.commands.symbol_pins import SymbolPinCommands
    from kicad_mcp.commands.update_symbol_from_library import update_symbol_from_library
    from kicad_mcp.commands.add_library_symbol_property import add_library_symbol_property
    from kicad_mcp.commands.add_symbol_property import add_symbol_property
...
class KiCADInterface(SchematicHandlersMixin):
    ...
    def _handle_find_unconnected_pins(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            from kicad_mcp.commands.schematic_analysis import find_unconnected_pins
    ...
    def _handle_get_net_connections(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            from kicad_mcp.commands.wire_connectivity import get_connections_for_net
    ...
    def _handle_find_overlapping_elements(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            from kicad_mcp.commands.schematic_analysis import find_overlapping_elements
    ...
    def _handle_get_elements_in_region(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            from kicad_mcp.commands.schematic_analysis import get_elements_in_region
    ...
    def _handle_import_svg_logo(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            from kicad_mcp.commands.svg_import import import_svg_to_pcb
...
""")
    ...
    def _handle_download_jlcpcb_database(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        from kicad_mcp.commands import jlcpcb_downloader
