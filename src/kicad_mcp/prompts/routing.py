...
Guides the LLM in routing strategy, differential pairs, high-speed signals,
power distribution and via planning. Ported from src/prompts/routing.ts.
(The TS versions left literal ``{{placeholder}}`` text in the templates; here
the arguments are actually interpolated.)
"""
...
def routing_strategy(
    board_info: Annotated[
        str,
        Field(
            description=(
                "Information about the PCB board, including dimensions, layer "
                "stack-up, and components"
            )
        ),
    ],
) -> str:
    """Develop a comprehensive routing strategy for a PCB design."""
...
def differential_pair_routing(
    differential_pairs: Annotated[
        str,
        Field(
            description=(
                "Information about the differential pairs to be routed, including "
                "signal names, source and destination components, and "
                "speed/frequency requirements"
            )
        ),
    ],
) -> str:
    """Best-practice guidance for routing differential pairs."""
...
def high_speed_routing(
    high_speed_signals: Annotated[
        str,
        Field(
            description=(
                "Information about the high-speed signals to be routed, including "
                "signal names, source and destination components, and "
                "speed/frequency requirements"
            )
        ),
    ...
    """Guidance for routing high-speed signals."""
...
def power_distribution(
    power_requirements: Annotated[
        str,
        Field(
            description=(
                "Information about the power requirements, including voltage "
                "rails, current needs, and components requiring power"
            )
        ),
    ],
) -> str:
    """Design guidance for the power distribution network."""
...
def via_usage(
    board_info: Annotated[
        ...
        Field(
            description=(
                "Information about the PCB board, including layer count, "
                "thickness, and design requirements"
            )
        ),
    ],
) -> str:
    """Plan via types, sizes and placement for a PCB design."""
